...
public class ServerAdressResolverTest {

	private ServerAdressResolver ServerAddressValidator;

	@BeforeMethod
	public void setUp() {
		ServerAddressValidator = new ServerAdressResolver();
	}
	...
	public void ValidIPAddressTest(String ip) {
		boolean valid = ServerAddressValidator.validate(ip);
